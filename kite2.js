		...
		$(this).find('li').each(function(){
			...
			$(tbody).find('tr').each(function(){
				...
				if(orderQnty > ORDER_QTY && totalOrders == NO_OF_ORDERS){
					var msg = symName+"\nBUY Order at - "+priceAt+"\nOrder Quantity "+orderQnty+"\nNo. Orders "+totalOrders;
					console.log(msg);
					$( ".unit-25" ).append( "<div class='btn btn-default abcde' onmouseover=closeDiv()>"
												+   msg+"</div>" );
					giveAlert();
				}
			});
			...
			$(SellTbody).find('tr').each(function(){
				...
				if(SellOrderQnty > ORDER_QTY && SellTotalOrders == NO_OF_ORDERS){
					var msg2 = symName+"\nSELL Order at : "+SellPriceAt+"\nOrder Quantity "+SellOrderQnty+" \nNo. Orders : "+SellTotalOrders;
					console.log(msg2);
					$( ".unit-25" ).append( "<div class='btn btn-default abcde' onmouseover=closeDiv()>"
												+   msg2+"</div>" );
					giveAlert();
